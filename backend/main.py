...
# Also one more Note:
# If you get to see this message 
# Hi All,
# Pls note revision in grid for Agriculture Tractor W/o Trailer
# Product - Agriculture Tractor W/o Trailer
# Age - All
# Business Type - Non fresh
# LOB - Comp
# TC - Grid + 2.5%
# RTO - Entire Maharashtra excluding Mumbai
# Valid - 16th Jan'25 till 31st Mar'35

# please ignore these kind of message because see , the payrate carefully , it is TC - Grid + 2.5% in this example , but the GRID value is unsure here , so please ignore this 

# I am giving you the second Example:
...
# Here in this example Everything is given good , in this kind of example , so please extract and give the required output .
# The main thing is Data can be given in any format, just use your intelligence and please extract , I have given you or can say trained you what types of data can come 
# Remember one thing , some data may appear identitcal or similar , don't get hallucinated , just give whatever there as it is

# Sometimes the data in the input is given this also
# NOTE : This is to inform you that our email domain has changed from relianceada.com to indusindirsurance .. com
# HI Krunal,
# Pls find the revised school bus & Scooter STP grid w.e.f 15th May
# School Bus :
# Q1 Special scheme - Additional 1% wil be released on Q1 business subject to a min of 5 Cr from School bus In Q1.
# Scooter :
# Yamaha and EV : Grid -5%
# Regards
# Gaurav

# Please ignore this as the Payrate Yamaha and EV : Grid -5% , here is not known what is Grid , so ignore such kind of message

# Also , if there are Requested Grid and Approved Grid column then please consider Approved Grid column
...
#     remarks == "NIL" or
#     remarks.strip() == "" or
#     remarks_lower in ("all fuel", "zuno - 21") or
#     any(word in record.get('remark', '').lower() for word in remarks_lower.split())
# )
